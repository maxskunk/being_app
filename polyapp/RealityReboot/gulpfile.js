...
gulp.task('images', function () {
    return imageOptimizeTask('www/images/**/*', dist('images'));
});
...
gulp.task('copy', function () {
    ...
    var bower = gulp.src([
    'www/bower_components/{webcomponentsjs,platinum-sw,sw-toolbox,promise-polyfill}/**/*'
  ]).pipe(gulp.dest(dist('bower_components')));

    return merge(www, bower)
        .pipe($.size({
            title: 'copy'
        }));
});
...
gulp.task('html', function () {
    ...
    ['www/**/*.html', '!www/{elements,test,bower_components}/**/*.html'],
        dist());
});
...
gulp.task('serve', ['lint', 'styles', 'elements'], function () {
    ...
    gulp.watch(['www/{scripts,elements}/**/{*.js,*.html}'], ['lint']);
